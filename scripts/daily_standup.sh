#!/bin/bash
# daily_standup.sh — Start the day: health check + digest + today's focus
...
# 1. System health
echo -e "${BOLD}[1/3] SYSTEM HEALTH${RESET}"
python scripts/health_check.py 2>&1

echo ""
echo -e "${BOLD}${GOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo -e "${BOLD}[2/3] MORNING DIGEST (preview — no email sent)${RESET}"
python -m projects.shared.personal-assistant.src.morning_digest --preview 2>&1 || echo "  (digest unavailable)"

echo ""
echo -e "${BOLD}${GOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo -e "${BOLD}[3/3] QUICK LINKS${RESET}"
...
echo "  n8n Dashboard: http://34.193.98.97:5678"
