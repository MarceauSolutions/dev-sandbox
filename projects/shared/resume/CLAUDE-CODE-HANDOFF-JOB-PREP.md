...
**Location:** `projects/shared/resume/`
...
1. **Review master data** - Ensure it's current
   ```bash
   cat projects/shared/resume/src/resume_data.json
   ```
...
4. **PDF Generation:**
   ```bash
   cd projects/shared/resume/output
...
**Read the full guide:** `projects/shared/resume/workflows/linkedin-github-presence.md`
...
**Location:** `projects/shared/job-tracker/`
...
cd /Users/williammarceaujr./dev-sandbox/projects/shared/resume
