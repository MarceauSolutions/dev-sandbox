...
**Title Options:**
- "Peptides Explained: What Every Fitness Enthusiast Should Know in 2026"
- "The Truth About Peptides for Recovery & Performance"
- "Peptides 101: Science, Benefits, and What I've Learned"
...
## SECTION 1: What Are Peptides? (0:30 - 2:30)
...
- [ ] Gym training footage (compound lifts)
- [ ] Supplement shelf / organization
- [ ] Working at computer (research)
- [ ] Blood work / lab visit (if available)
- [ ] Morning routine clips
- [ ] Food prep
- [ ] Recovery (stretching, sauna, etc.)

---

## POST-PRODUCTION NOTES

**For Claude (Video Editing):**
1. Add jump cuts to remove pauses/stumbles
2. Add text overlays for peptide names and categories
3. Add simple graphics for frameworks/lists
4. Background music: Lo-fi or subtle electronic (not distracting)
5. Add subscribe animation at CTA
6. Color grade for consistency
7. Add chapter markers for YouTube

**Thumbnail Ideas:**
- Face with "PEPTIDES" text
- Before/after vibe (without being misleading)
- Laboratory aesthetic with fitness elements
...
- [ ] Good lighting (ring light + window)
- [ ] Clean background
- [ ] Lavalier mic or shotgun mic
- [ ] Camera at eye level
- [ ] Teleprompter or bullet points visible
- [ ] Water nearby
- [ ] Phone on silent
- [ ] Record room tone (10 sec silence for editing)
