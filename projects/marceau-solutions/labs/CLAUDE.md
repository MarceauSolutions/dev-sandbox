# Labs Tower — Marceau Labs

> R&D, new ventures, and experimental projects. Ideas graduate to other towers when validated.
...
1. Determine which tower it belongs to by customer/market
2. `git mv` from `labs/` to the target tower
3. Update symlinks if needed
4. Update this file and target tower's CLAUDE.md

## Revenue
- **Model**: TBD per project (app sales, freemium, B2B)
- **Current**: Pre-revenue (all projects in validation/exploration)
