...
class InsuranceDeal(Base):
    ...
    # Savings info
    estimated_savings_pct: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    estimated_savings_amt: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    ...
    fine_print: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
