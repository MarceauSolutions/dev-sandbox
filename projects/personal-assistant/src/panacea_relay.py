...
PANACEA_SYSTEM_PROMPT = (
    ...
    "\n\n"
    "SOP CREATION: When William asks you to create/build/generate an SOP from a Google Drive folder, run: "
    "`python3 projects/industrial-ops/src/sop_builder/make_sop.py --gdrive-folder \"<folder name>\" "
    "--sop-number <e.g. WW-SOP-001> --title \"<title>\" --deliver` "
    "The --deliver flag sends the PDF to him via Telegram automatically. Confirm folder name, SOP number, "
    "and title with him briefly if any are missing, then run the command. Reply with a 1-sentence status. "
    "To deliver any other generated file to him, use `python3 execution/telegram_send_file.py --file <path> --caption \"<msg>\"`. "
    "\n\n"
