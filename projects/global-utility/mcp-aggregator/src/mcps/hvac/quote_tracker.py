...
from .models import RFQ, Quote, RFQStatus, RFQSpecifications, Distributor
...
class QuoteTracker:
    ...
    def __init__(self, db_path: Optional[str] = None):
        ...
        Args:
            db_path: Path to SQLite database. Defaults to ./hvac_quotes.db
        """
        self.db_path = db_path or os.environ.get(
            'HVAC_DB_PATH',
            os.path.join(os.path.dirname(__file__), 'hvac_quotes.db')
        )
        self._init_db()
