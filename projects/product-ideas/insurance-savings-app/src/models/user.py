...
class UserProfile(Base):
    ...
    driving_record: Mapped[Optional["DrivingRecord"]] = relationship(back_populates="user", uselist=False, cascade="all, delete-orphan")
...
class Vehicle(Base):
    ...
    trim: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    vin: Mapped[Optional[str]] = mapped_column(String(17), nullable=True)
    annual_mileage: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
...
class CurrentPolicy(Base):
    ...
    liability_bodily: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)  # e.g., "100/300"
    liability_property: Mapped[Optional[float]] = mapped_column(Float, nullable=True)  # e.g., 100000
    ...
    medical_payments: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
...
class DrivingRecord(Base):
    ...
    years_licensed: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    credit_score_range: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    education_level: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)  # high_school, bachelors, masters, phd
