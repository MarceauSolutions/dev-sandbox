...
TIERS:
    ...
    3 — Complete System  ($997/mo + $1,000 setup)  STRIPE_TIER3_PAYMENT_LINK
...
TIER_CONFIG = {
    1: {
        "name": "Tier 1 — Starter",
        "summary": "Missed-call text-back, after-hours routing, review requests",
        "setup": "$500",
        "monthly": "$297/month",
    ...
    2: {
        "name": "Tier 2 — Growth",
        "summary": "Everything in Starter + conversational AI agent, appointment booking, lead qualification",
        "setup": "$750",
        "monthly": "$497/month",
    ...
    3: {
        ...
        "summary": "Everything in Growth + CRM, sales pipeline, lead nurture sequences, form automation, system optimization",
        "setup": "$1,000",
        "monthly": "$997/month",
...
def main():
    ...
    parser.add_argument("--tier", required=True, type=int, choices=[1, 2, 3],
                        help="Service tier: 1=Starter, 2=Growth, 3=Complete System")
