...
This MCP server wraps the rideshare REST API for Claude Desktop integration.
It translates MCP protocol calls to REST API requests.
...
For Claude Desktop, add to claude_desktop_config.json:
{
    "mcpServers": {
        "rideshare-comparison": {
            "command": "python",
            "args": ["/Users/williammarceaujr./dev-sandbox/projects/mcp-aggregator/mcp-server/rideshare_mcp.py"],
            "env": {
                "RIDESHARE_API_URL": "http://localhost:8000",
                "RIDESHARE_API_KEY": "test_free_key_12345"
            }
        }
    }
}
