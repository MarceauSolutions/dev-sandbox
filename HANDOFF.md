...
- **Personal study guide compiled** at `projects/marceau-solutions/hvac/epa-608-universal-study-guide.md` + branded PDF. 3 parts: (1) chart-aware strategy with full chart breakdown at top, (2) top priority study areas based on William's specific misses, (3) complete reference tables for memorize-only material, plus a quick-reference cheat sheet for last-minute review.
- **William's confirmed weak spots:** recovery vacuum levels per pressure category and charge size (kept defaulting to "15 something"), low-pressure system specifics (10 psig leak test vs 15 psig rupture disc), system-dependent vs self-contained recovery terminology, pressure category identification (medium vs high vs very-high).
- **Strong spots:** ASHRAE lookups (now chart-based anyway), refrigerant family identification, refrigeration cycle, ozone/GWP conceptual mechanism, HC refrigerants.
- **Next action for William:** Schedule and pay for the actual ESCO Universal proctored exam (~$50-75 via 800-726-9696). Review the personal study guide's Part 1 and Quick-Reference Cheat Sheet the night before the exam. Practice locating refrigerants on the PT chart for speed.
